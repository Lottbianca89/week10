 ...
 *
 * ↓ YOUR CODE HERE ↓ */
const myFunction = document.getElementById('myButton').addEventListener('click', () => {
   console.log(e.target)
document.body.backgroundColor = `rgb $(Math.random() * 255}, $(Math.random() * 255}, $(Math.random() * 255)) `
})
